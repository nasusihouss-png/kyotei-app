...
assert.equal(typeof enhancement.upsetSupport?.classification, "string");
assert.equal(typeof enhancement.stage5_ticketing?.upset_support?.classification, "string");
assert.equal(typeof enhancement.upsetSupport?.big_upset_probability, "number");
assert.equal(Array.isArray(enhancement.upsetSupport?.upset_formation?.first_candidates), true);
assert.equal(Array.isArray(enhancement.upsetSupport?.upset_formation?.second_candidates), true);
assert.equal(Array.isArray(enhancement.upsetSupport?.upset_formation?.third_candidates), true);
assert.equal(Array.isArray(enhancement.upsetSupport?.chosen_upset_heads), true);
assert.equal(Array.isArray(enhancement.upsetSupport?.chosen_exacta_pairs || enhancement.upsetSupport?.upset_exacta_pairs), true);
assert.equal(Array.isArray(enhancement.upsetSupport?.chosen_trifecta_tickets || enhancement.upsetSupport?.upset_trifecta_tickets), true);
