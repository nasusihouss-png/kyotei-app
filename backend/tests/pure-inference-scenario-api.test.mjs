  ...
  return {
    ...
    featureSnapshot: {
      ...
      coverage_report: {
        ...
        lane_1st_rate: { status: "ok", value: 65 - lane * 3, normalized: 65 - lane * 3, required: lane <= 4 },
        lane_2ren_rate: { status: "ok", value: 72 - lane * 3, normalized: 72 - lane * 3, required: lane <= 4 },
        lane_3ren_rate: { status: "ok", value: 80 - lane * 3, normalized: 80 - lane * 3, required: lane <= 4 },
