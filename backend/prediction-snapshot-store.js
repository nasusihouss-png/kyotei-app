  ...
  return verificationRows
    .map((verificationRow) => {
      ...
      return {
        ...
        launch_venue_calibration_json:
          learning?.launch_venue_calibration_json || context?.launch_venue_calibration_json || {},
        ...
        f_holder_role_penalty_summary_json:
          learning?.f_holder_role_penalty_summary_json || context?.f_holder_role_penalty_summary_json || {},
