...
function normalizeTendency(row = {}) {
  ...
  return {
    ...
    currentSeasonAvgST: firstFinite(row?.currentSeasonAvgST, row?.current_season_avg_st, row?.seasonAvgST, row?.season_avg_st, tendency?.currentSeasonAvgST),
    currentSeasonStartCount: firstFinite(row?.currentSeasonStartCount, row?.current_season_start_count, row?.seasonStartCount, row?.season_start_count, tendency?.currentSeasonStartCount),
    currentSeasonLateStartRate: firstFinite(row?.currentSeasonLateStartRate, row?.current_season_late_start_rate, row?.seasonLateStartRate, row?.season_late_start_rate, tendency?.currentSeasonLateStartRate),
    currentSeasonEarlyStartRate: firstFinite(row?.currentSeasonEarlyStartRate, row?.current_season_early_start_rate, row?.seasonEarlyStartRate, row?.season_early_start_rate, tendency?.currentSeasonEarlyStartRate),
    currentSeasonStartStabilityRate: firstFinite(row?.currentSeasonStartStabilityRate, row?.current_season_start_stability_rate, row?.seasonStartStabilityRate, row?.season_start_stability_rate, tendency?.currentSeasonStartStabilityRate),
    startStabilityRate: firstFinite(row?.startStabilityRate, row?.start_stability_rate, tendency?.startStabilityRate),
...
export function normalizeRaceEntry(row = {}, previewRow = null) {
  ...
  return {
    ...
    currentSeasonAvgST: tendency.currentSeasonAvgST,
    currentSeasonStartCount: tendency.currentSeasonStartCount,
    currentSeasonLateStartRate: tendency.currentSeasonLateStartRate,
    currentSeasonEarlyStartRate: tendency.currentSeasonEarlyStartRate,
    currentSeasonStartStabilityRate: tendency.currentSeasonStartStabilityRate,
    startStabilityRate: tendency.startStabilityRate,
