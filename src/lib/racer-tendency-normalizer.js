...
export function normalizeRacerTendencyRow(row = {}) {
  ...
  return {
    ...
    courseWinRate: rate(row?.courseWinRate, row?.course_win_rate, row?.localCourseWinRate, row?.local_course_win_rate, playerTendency?.courseWinRate, playerTendency?.localCourseWinRate),
    courseQuinellaRate: rate(row?.courseQuinellaRate, row?.course_quinella_rate, row?.course2Rate, row?.course_2rate, row?.localCourseQuinellaRate, row?.local_course_quinella_rate, playerTendency?.courseQuinellaRate, playerTendency?.localCourseQuinellaRate),
    courseTrifectaRate: rate(row?.courseTrifectaRate, row?.course_trifecta_rate, row?.course3Rate, row?.course_3rate, row?.localCourseTrifectaRate, row?.local_course_trifecta_rate, playerTendency?.courseTrifectaRate, playerTendency?.localCourseTrifectaRate),
    recentWinRate: rate(row?.recentWinRate, row?.recent_win_rate, playerTendency?.recentWinRate),
    recentQuinellaRate: rate(row?.recentQuinellaRate, row?.recent_quinella_rate, row?.recent2Rate, row?.recent_2rate, playerTendency?.recentQuinellaRate),
    recentTrifectaRate: rate(row?.recentTrifectaRate, row?.recent_trifecta_rate, row?.recent3Rate, row?.recent_3rate, playerTendency?.recentTrifectaRate),
    localVenueWinRate: rate(row?.localVenueWinRate, row?.local_venue_win_rate, row?.localWinRate, row?.local_win_rate, playerTendency?.localVenueWinRate),
    localVenueQuinellaRate: rate(row?.localVenueQuinellaRate, row?.local_venue_quinella_rate, row?.local2Rate, row?.local_2rate, playerTendency?.localVenueQuinellaRate),
    localVenueTrifectaRate: rate(row?.localVenueTrifectaRate, row?.local_venue_trifecta_rate, row?.local3Rate, row?.local_3rate, playerTendency?.localVenueTrifectaRate),
...
export function buildTendencyPreview(rows = []) {
  return normalizeRacerTendencyRows(rows).map((row) => ({
    ...
    localVenueWinRate: row.localVenueWinRate,
