  ...
  const boats = sourceRows
    .map((row) => {
      ...
      const playerTendency = {
        ...
        courseWinRate: entry.courseWinRate ?? row?.playerTendency?.courseWinRate ?? null,
        courseQuinellaRate: entry.courseQuinellaRate ?? row?.playerTendency?.courseQuinellaRate ?? null,
        courseTrifectaRate: entry.courseTrifectaRate ?? row?.playerTendency?.courseTrifectaRate ?? null,
        recentWinRate: entry.recentWinRate ?? row?.playerTendency?.recentWinRate ?? null,
        recentQuinellaRate: entry.recentQuinellaRate ?? row?.playerTendency?.recentQuinellaRate ?? null,
        recentTrifectaRate: entry.recentTrifectaRate ?? row?.playerTendency?.recentTrifectaRate ?? null,
        localVenueWinRate: entry.localVenueWinRate ?? row?.playerTendency?.localVenueWinRate ?? null,
        localVenueQuinellaRate: entry.localVenueQuinellaRate ?? row?.playerTendency?.localVenueQuinellaRate ?? null,
        localVenueTrifectaRate: entry.localVenueTrifectaRate ?? row?.playerTendency?.localVenueTrifectaRate ?? null,
        avgST: entry.avgST ?? row?.playerTendency?.avgST ?? null,
        avgStartTiming: entry.avgST ?? row?.playerTendency?.avgStartTiming ?? null,
        currentSeasonAvgST: entry.currentSeasonAvgST ?? row?.playerTendency?.currentSeasonAvgST ?? null,
        currentSeasonStartCount: entry.currentSeasonStartCount ?? row?.playerTendency?.currentSeasonStartCount ?? null,
        currentSeasonLateStartRate: entry.currentSeasonLateStartRate ?? row?.playerTendency?.currentSeasonLateStartRate ?? null,
        currentSeasonEarlyStartRate: entry.currentSeasonEarlyStartRate ?? row?.playerTendency?.currentSeasonEarlyStartRate ?? null,
        currentSeasonStartStabilityRate: entry.currentSeasonStartStabilityRate ?? row?.playerTendency?.currentSeasonStartStabilityRate ?? null,
        startStabilityRate: entry.startStabilityRate ?? row?.playerTendency?.startStabilityRate ?? null,
      ...
      return {
        ...
        courseWinRate: entry.courseWinRate ?? null,
        courseQuinellaRate: entry.courseQuinellaRate ?? null,
        courseTrifectaRate: entry.courseTrifectaRate ?? null,
        recentWinRate: entry.recentWinRate ?? null,
        recentQuinellaRate: entry.recentQuinellaRate ?? null,
        recentTrifectaRate: entry.recentTrifectaRate ?? null,
        localVenueWinRate: entry.localVenueWinRate ?? null,
        localVenueQuinellaRate: entry.localVenueQuinellaRate ?? null,
        localVenueTrifectaRate: entry.localVenueTrifectaRate ?? null,
        avgST: entry.avgST ?? null,
        currentSeasonAvgST: entry.currentSeasonAvgST ?? null,
        currentSeasonStartCount: entry.currentSeasonStartCount ?? null,
        currentSeasonLateStartRate: entry.currentSeasonLateStartRate ?? null,
        currentSeasonEarlyStartRate: entry.currentSeasonEarlyStartRate ?? null,
        currentSeasonStartStabilityRate: entry.currentSeasonStartStabilityRate ?? null,
        startStabilityRate: entry.startStabilityRate ?? null,
